...
// 摄像头的个数
#define X 65    // 每行摄像头的数量
#define Y 10     // 每列摄像头的数量
#define X_WIDTH 1.54// 每行相邻摄像头的间距
